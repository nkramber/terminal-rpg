...
| Map scene, battle scene, hub scene, scene runner | Game | Core state, atlas, edge files, string table | screen, intents | Medium. Cosmetic by design (D-106, D-111, D-114, D-501). Player text reaches the screen through the text helper (D-499) |
